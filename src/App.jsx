    ...
    <div style={{background:C.n,color:C.w,fontFamily:"'Aptos','Segoe UI',sans-serif",overflowX:"hidden",opacity:1}}>
      <style>{`
        ...
        *{margin:0;padding:0;box-sizing:border-box}html{scroll-behavior:smooth}
        ...
        @media(max-width:768px){
          ...
          #heroVid{object-fit:cover!important;object-position:center 20%!important;height:140%!important;top:-10%!important}
        ...
        @media(max-width:480px){
          #heroVid{object-fit:cover!important;object-position:center 15%!important;height:160%!important;top:-15%!important}
          #mstats-top{display:none!important}
          #mstats-bottom{display:block!important}
        }
      ...
      <section id="home" style={{position:"relative",minHeight:"100vh",display:"flex",alignItems:"flex-end",paddingBottom:"clamp(4rem,8vw,8rem)",overflow:"hidden",background:C.n}}>
        <div style={{position:"absolute",inset:0,zIndex:0}}>
          <video id="heroVid" autoPlay muted loop playsInline style={{position:"absolute",inset:0,objectFit:"cover",width:"100%",height:"100%"}}><source src="./hero.mp4" type="video/mp4"/></video>
        </div>
        {/* Dark overlay */}
