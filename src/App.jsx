...
function Hero({ go, variant }) {
  ...
  return (
    <section id="home" data-screen-label="Hero" style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "flex-end", paddingBottom: variant === "b" ? "clamp(6rem,10vw,9rem)" : variant === "d" ? "clamp(2.5rem,5vw,4.5rem)" : "clamp(4rem,8vw,8rem)", overflow: split ? "visible" : "hidden", background: "var(--night)" }}>
...
function Skyline() {
  return (
    <svg viewBox="0 0 400 160" fill="none" style={{ width: 220, height: 88, flexShrink: 0 }}>
      ...
      <circle cx="165" cy="2" r="3" fill="#e23c41" opacity=".7"><animate attributeName="opacity" values=".7;.15;.7" dur="2s" repeatCount="indefinite" /></circle>
      <rect x="156" y="50" width="3" height="3" fill="#fff" opacity=".3"><animate attributeName="opacity" values=".3;.8;.3" dur="3s" repeatCount="indefinite" /></rect>
      <rect x="232" y="80" width="3" height="3" fill="#fff" opacity=".3"><animate attributeName="opacity" values=".3;.8;.3" dur="4s" begin="1.5s" repeatCount="indefinite" /></rect>
      <rect x="290" y="100" width="3" height="3" fill="#e23c41" opacity=".25"><animate attributeName="opacity" values=".25;.7;.25" dur="4.5s" begin="1s" repeatCount="indefinite" /></rect>
    </svg>
  );
}
function Footer({ go }) {
